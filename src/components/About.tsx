const About = () => {
  return (
    <div className="grid place-items-center  text-background py-[120px] px-16 bg-primaryText mt-2">
      ...
      <span className="text-xl text-center pt-6">
        ...
        programming and tech skills <br /> I've developed throughout my journey.
      </span>
    </div>
  );
};
